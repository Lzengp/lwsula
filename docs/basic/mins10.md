...
```jsx
import React from 'react';
import { QueryTable, Icon } from 'goldjetsula';
import { DeleteOutlined } from '@ant-design/icons';
...
- 注册示例如下
```js
import { registerFieldPlugins, registerRenderPlugins, registerActionPlugins, registerFilterPlugins, Icon } from 'goldjetsula';
